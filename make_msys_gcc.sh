...
# Clean
make -f Make_ming.mak GUI=yes clean ARCH=x86-64
make -f Make_ming.mak GUI=no  clean ARCH=x86-64

# GUI x64
make -f Make_ming.mak GUI=yes OLE=yes FEATURES=HOGE ARCH=x86-64

# # console x64
make -f Make_ming.mak GUI=no OLE=yes FEATURES=HOGE ARCH=x86-64
